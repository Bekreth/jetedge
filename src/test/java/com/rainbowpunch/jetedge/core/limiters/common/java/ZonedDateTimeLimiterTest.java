...
public class ZonedDateTimeLimiterTest {
    ...
    private static final Date DEFAULT_ORIGIN_DATE = new Date(100000L);
    ...
    @Test
    public void testZonedDateTimeLimiterWithDateBound() {
        ZonedDateTime bound = ZonedDateTime.ofInstant(DEFAULT_BOUND_DATE.toInstant(), DEFAULT_ZONE_ID);
        ZonedDateTimeLimiter zonedDateTimeLimiter = new ZonedDateTimeLimiter(DEFAULT_BOUND_DATE);
    ...
    @Test
    public void testZonedDateTimeLimiterWithDateBoundAndRandomZoneId() {
        ZonedDateTime bound = ZonedDateTime.ofInstant(DEFAULT_BOUND_DATE.toInstant(), DEFAULT_ZONE_ID);
        ZonedDateTimeLimiter zonedDateTimeLimiter = new ZonedDateTimeLimiter(DEFAULT_BOUND_DATE, true);
    ...
    @Test
    public void testZonedDateTimeLimiterWithDateBoundAndZoneId() {
        ZonedDateTime bound = ZonedDateTime.ofInstant(DEFAULT_BOUND_DATE.toInstant(), DEFAULT_ZONE_ID);
        ZonedDateTimeLimiter zonedDateTimeLimiter = new ZonedDateTimeLimiter(DEFAULT_BOUND_DATE, DEFAULT_ZONE_ID);
    ...
    @Test
    public void testZonedDateTimeLimiterWithDateOriginAndDateBound() {
        ZonedDateTime origin = ZonedDateTime.ofInstant(DEFAULT_ORIGIN_DATE.toInstant(), DEFAULT_ZONE_ID);
        ZonedDateTime bound = ZonedDateTime.ofInstant(DEFAULT_BOUND_DATE.toInstant(), DEFAULT_ZONE_ID);
        ZonedDateTimeLimiter zonedDateTimeLimiter = new ZonedDateTimeLimiter(DEFAULT_ORIGIN_DATE, DEFAULT_BOUND_DATE);
